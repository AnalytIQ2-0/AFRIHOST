window.addEventListener("load", function(){
    ...
    urltable.open('POST', "http://localhost/github/AUHF/Afrihost/PHPs/getEvents.php");
 ...
 function loadEventTable(res) {
    var  htmlString ="";
            for (var i = 0; i < res.length; i++) {
                ...
                htmlString += '<tr class="tablerow"><td class="col1" onclick="parseEventId()"><a href="memberViewEvent.html">' + parseInt(res[i].event_id) +
