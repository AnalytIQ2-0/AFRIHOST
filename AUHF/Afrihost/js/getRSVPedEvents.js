window.addEventListener("load", function(){
    ...
    urltable.open('POST', "http://localhost/AUHF/Afrihost/PHPs/RSVPedEvents.php");
 ...
 function loadEventTable(res) {
    var  htmlString ="";
            for (var i = 0; i < res.length; i++) {
                ...
                htmlString += '<tr class="tablerow"><td class="col1" onclick="parseEventId()"><a href="viewRSVPedMembers.html">' + parseInt(res[i].event_id) +
