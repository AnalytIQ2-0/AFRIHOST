window.addEventListener("load",function(){
    ...
    urlRe.open("GET","http://localhost/AUHF/Afrihost/PHPs/listMembers.php");
...
function HtmlOutput(data){
  ...
  if(!hold.localeCompare("false")){
    ...
    for(i =0; i <data.length;i++){
      htmlString += '<tr><td class=col1 onclick="parseMid()"><a href="ConversationList.html" >'+data[i].member_id+
